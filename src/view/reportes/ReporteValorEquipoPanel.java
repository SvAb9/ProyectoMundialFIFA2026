...
public class ReporteValorEquipoPanel extends JPanel {
    ...
    public ReporteValorEquipoPanel() {
    ...
    private JPanel buildHeader() {
        ...
        p.setBackground(BG);
        JLabel t = new JLabel("Reporte: valor total por equipo");
        t.setFont(new Font("Segoe UI", Font.BOLD, 20));
        t.setForeground(TEXT_PRI);
        JLabel s = new JLabel("Selecciona una confederación para ver el valor de sus equipos");
    ...
    private JScrollPane buildTabla() {
        modelo = new DefaultTableModel(
                new String[]{"Equipo", "Confederación", "Valor total (€)"}, 0) {
    ...
    private JPanel buildFiltro() {
        ...
        cmbConf.setPreferredSize(new Dimension(220, 38));
        cmbConf.setMaximumSize(new Dimension(220, 38));
        for (Confederacion c : confDAO.listarTodos()) cmbConf.addItem(c);
    ...
    private void ejecutarConsulta() {
        ...
        List<Equipo> lista = controller.valorTotalPorConfederacion(conf.getIdConfederacion());
        for (Equipo e : lista)
        ...
        if (lista.isEmpty())
            JOptionPane.showMessageDialog(this, "Sin equipos para esta confederación.", "Info", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void generarPDF() {
        ...
        fc.setSelectedFile(new java.io.File("reporte_valor_equipo.pdf"));
        ...
        try {
            ...
            PDFGenerator.generar(
                    ...
                    "Reporte: valor total por equipo",
                    "Confederación: " + (conf != null ? conf.getNombre() : ""),
                    new String[]{"Equipo", "Confederación", "Valor total (€)"},
                    filas
            );
