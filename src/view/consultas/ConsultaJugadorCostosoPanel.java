...
/**
 * ConsultaJugadorCostosoPanel
 * "Determinar los datos del jugador más costoso por confederación."
 */
public class ConsultaJugadorCostosoPanel extends JPanel {
    ...
    public ConsultaJugadorCostosoPanel() {
    ...
    private JPanel buildHeader() {
        ...
        p.setBackground(BG);
        JLabel t = new JLabel("Jugador más costoso por confederación");
        t.setFont(new Font("Segoe UI", Font.BOLD, 20));
        t.setForeground(TEXT_PRI);
        JLabel s = new JLabel("Muestra el jugador de mayor valor en cada confederación");
    ...
    private JScrollPane buildTabla() {
        modelo = new DefaultTableModel(
                new String[]{"Confederación", "Jugador", "Equipo", "Posición", "Valor (€)"}, 0) {
    ...
    private void ejecutarConsulta() {
        ...
        List<Jugador> lista = controller.jugadorMasCostosoPorConfederacion();
        for (Jugador j : lista) {
